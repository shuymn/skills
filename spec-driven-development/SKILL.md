...
- Claude Code presents the "requirements file" to the user and asks if there are any issues using AskUserQuestionTool
...
- Claude Code presents the "design file" to the user and asks if there are any issues using AskUserQuestionTool
...
- Claude Code presents the "implementation plan file" to the user and asks if there are any issues using AskUserQuestionTool
